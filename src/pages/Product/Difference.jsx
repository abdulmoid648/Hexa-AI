                    ...
                    <div className="bg-[#FAF9FA] rounded-[1rem] p-10 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <ul className="space-y-5">
                            <li className="flex items-start gap-4">
                                ...
                                <span className="text-base text-gray-600">No prior context is shared.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-[#52C45A] flex items-center justify-center shrink-0">
                                    <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                ...
                                <span className="text-base text-gray-600">Agents will need to search for context.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-[#52C45A] flex items-center justify-center shrink-0">
                                    <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                ...
                                <span className="text-base text-gray-600">Low-touch, speed-focused approach</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-[#FAF9FA] rounded-[1rem] p-10 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                        ...
                        <ul className="space-y-5">
                            <li className="flex items-start gap-4">
                                ...
                                <span className="text-base text-gray-600">The next agent gets all the context they need.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-[#52C45A] flex items-center justify-center shrink-0">
                                    <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                ...
                                <span className="text-base text-gray-600">Includes agent introduction to help build trust with customers.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="mt-0.5 w-5 h-5 rounded-full bg-[#52C45A] flex items-center justify-center shrink-0">
                                    <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                                ...
                                <span className="text-base text-gray-600">Builds trust and loyalty</span>
                            </li>
                        </ul>
                    </div>
                </div>
