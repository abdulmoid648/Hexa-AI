        ...
        <div className="min-h-screen w-full bg-white relative flex flex-col items-center justify-center font-sans overflow-hidden">
            ...
            <div className="w-full max-w-md px-6 py-5 relative z-10 flex flex-col items-left mt-20">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full pl-11 pr-4 py-3 bg-white border border-blue-400 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm"
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="block w-full pl-11 pr-12 py-3 bg-slate-50 border border-blue-400 rounded-xl text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm"
                ...
                <div className="w-full space-y-4">
                    <button className="w-full flex items-center justify-center gap-3 bg-[#f8f9fa] border border-blue-400 hover:border-blue-200 hover:bg-white text-[14px] font-semibold text-gray-700 py-3.5 rounded-xl transition-all duration-200 shadow-sm active:scale-[0.98]">
